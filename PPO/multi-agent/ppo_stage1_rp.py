...
from model.net_rp import MLPPolicy, CNNPolicy
from stage_world_rp import StageWorld
from model.ppo_rp import ppo_update_stage1, generate_train_data
from model.ppo_rp import generate_action
from model.ppo_rp import transform_buffer
...
if __name__ == '__main__':
    ...
    # np.random.seed(1)
    if rank == 0:
        policy_path = 'policy_0806_agent10_point'
