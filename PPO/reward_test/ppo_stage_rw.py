...
from simple_world_rw import StageWorld
...
if __name__ == '__main__':
    ...
    if not os.path.exists('./log/' + hostname + 'reward_rw'):
        os.makedirs('./log/' + hostname + 'reward_rw')
    output_file = './log/' + hostname + 'reward_rw' + '/output.log'
    cal_file = './log/' + hostname + 'reward_rw' + '/cal.log'
    ...
    # np.random.seed(1)
    if rank == 0:
        policy_path = 'policy_0812_reward_rw'
