...
from simple_world_rt2 import StageWorld
...
if __name__ == '__main__':
    ...
    if not os.path.exists('./log/' + hostname + 'reward_t05'):
        os.makedirs('./log/' + hostname + 'reward_t05')
    output_file = './log/' + hostname + 'reward_t05' + '/output.log'
    cal_file = './log/' + hostname + 'reward_t05' + '/cal.log'
    ...
    # np.random.seed(1)
    if rank == 0:
        policy_path = 'policy_0812_reward_t05'
        ...
        file = policy_path + '/rt05_19000.pth'
