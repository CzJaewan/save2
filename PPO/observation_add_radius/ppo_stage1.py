...
if __name__ == '__main__':
    ...
    if not os.path.exists('./log/' + hostname + 'radius2'):
        os.makedirs('./log/' + hostname + 'radius2')
    output_file = './log/' + hostname + 'radius2' + '/output.log'
    cal_file = './log/' + hostname + 'radius2' + '/cal.log'
    ...
    env = StageWorld(512, index=rank, num_env=NUM_ENV, robot_radius=RADIUS)
    ...
    # np.random.seed(1)
    if rank == 0:
        policy_path = 'policy_0814_radius'
        ...
        file = policy_path + '/radius_21000.pth'
