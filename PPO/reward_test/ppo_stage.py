...
if __name__ == '__main__':
    ...
    if not os.path.exists('./log/' + hostname + 'reward'):
        os.makedirs('./log/' + hostname + 'reward')
    output_file = './log/' + hostname + 'reward' + '/output.log'
    cal_file = './log/' + hostname + 'reward' + '/cal.log'
    ...
    # np.random.seed(1)
    if rank == 0:
        policy_path = 'policy_0812_reward'
        ...
        file = policy_path + '/origin_5000.pth'
