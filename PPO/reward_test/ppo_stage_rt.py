...
from simple_world_rt import StageWorld
...
if __name__ == '__main__':
    ...
    if not os.path.exists('./log/' + hostname + 'reward_t'):
        os.makedirs('./log/' + hostname + 'reward_t')
    output_file = './log/' + hostname + 'reward_t' + '/output.log'
    cal_file = './log/' + hostname + 'reward_t' + '/cal.log'
    ...
    # np.random.seed(1)
    if rank == 0:
        policy_path = 'policy_0812_reward_t'
