...
from simple_world_rt_c import StageWorld
...
if __name__ == '__main__':
    ...
    if not os.path.exists('./log/' + hostname + 'reward_c2'):
        os.makedirs('./log/' + hostname + 'reward_c2')
    output_file = './log/' + hostname + 'reward_c2' + '/output.log'
    cal_file = './log/' + hostname + 'reward_c2' + '/cal.log'
    ...
    # np.random.seed(1)
    if rank == 0:
        policy_path = 'policy_0819_reward_c2'
